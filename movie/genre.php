...
if($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    $sql = "SELECT DISTINCT movie FROM moviegenres WHERE genre='" . $genre . "' ORDER BY movie ASC";
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="topbar-filter fw">
					<p>Found <span><?php echo $count; ?> movies</span> in total</p>
					<!-- <label>Sort by:</label>
					<select>
				...
				<?php
				while($movies = mysqli_fetch_assoc($results)){
                    $name = $movies['movie'];
              ...
              <a  href="movie.php?movie=<?php echo $movie['name'];?>">
							<img class="lazy" data-src="http://dsconlimited.net/dsconlimitedmovies/<?php echo $movie['cover']; ?>" alt="">
            </a>
							<div class="mv-item-infor">
								<h6><a href="movie.php?movie=<?php echo $movie['name'];?>"><?php echo $movie['name']; ?></a></h6>
