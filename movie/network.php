...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    $sql = "SELECT * FROM series WHERE network = '" .  $network . "' ORDER BY seriesname ASC";
...
<head>
    <!-- Basic need -->
    <title>Dscon | <?php echo $network; ?></title>
    <meta charset="UTF-8">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="flex-wrap-movielist mv-grid-fw">
                        ...
                        while ($series = mysqli_fetch_assoc($results)) {
                            ...
                            ?>
                            <a href="series.php?tv-show=<?php echo $series['seriesname']; ?>">
                                <div class="movie-item-style-2 movie-item-style-1">
                                    <img class="lazy"  data-src="http://dsconlimited.net/dsconlimitedseries/<?php echo $series['folder']; ?>/<?php echo $series['poster']; ?>" alt="">

                                    <div class="mv-item-infor">
                                        <h6><a href="series.php?tv-show=<?php echo $series['seriesname']; ?>"><?php echo $series['seriesname']; ?></a></h6>
                                        <p class="rate"><i class="ion-android-star"></i><span><?php echo $series['vote_average']; ?></span> /10</p>
                                    </div>
                                </div>
                            </a>
                                <?php } ?>
