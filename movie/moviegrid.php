					...
					<div class="flex-wrap-movielist mv-grid-fw">
						...
						?>
							<div class="movie-item-style-2 movie-item-style-1">
								<a href="movie.php?movie=<?php echo $movies['name']; ?>">
									<img class="lazy" data-src="http://dsconlimited.net/dsconlimitedmovies/<?php echo $movies['cover']; ?>" alt="">
								</a>

								<div class="mv-item-infor">
									<h6><a href="#"><?php echo $movies['name']; ?></a></h6>
									<p class="rate"><i class="ion-android-star"></i><span><?php echo $movies['vote_average']; ?></span> /10</p>
								</div>
							</div>
						<?php } ?>
