...
$sql = "SELECT * FROM series ORDER BY seriesname ASC";
        ...
        <div class="row">
            <nav id="mainNav" class="navbar navbar-default navbar-custom">
                ...
                <div class="navbar-header logo">
                    ...
                    <a href="index.html"><img class="logo" src="images/logo/d_logo-transparent-black.png" alt="Dscon Logo" width="40" height="40"></a>
                </div>
                ...
                <div class="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav flex-child-menu menu-right">
                        ...
                        <li class="btn signupLink"><a href="../">Profile</a></li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
            </nav>
