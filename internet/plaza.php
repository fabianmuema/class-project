...
================================================== -->
        ...
        <div class="container">       
            ...
            <div class="row d-row justify-content-center">
                ...
                <div class="">
                    <div class="single-plan mb-4 mb-sm-5 mb-lg-0 green" style="  background-image:linear-gradient(to right, #11998e, #38ef7d);">
                        ...
                        <h4 class="plan-price" style=" color: white;">kshs 250 <br> per week</h4>
                        ...
                        <a class="btn single-plan-button" href="plazapayment.php?package=home&plan=1&freq=weekly" role="button">Order
                            Now</a>
                    <?php } ?>
                    </div>
                </div>
                ...
                <div class="">
                    <div class="single-plan plan-popular mb-4 mb-sm-5 mb-lg-0" style="  background-image:linear-gradient(to right, #2193b0, #6dd5ed);">
                        ...
                        <h4 class="plan-price">kshs 350 <br> per week</h4>
                        ...
                        <a class="btn plan-popular-button" href="plazapayment.php?package=home&plan=2&freq=weekly" role="button">Order
                            Now</a>
                    <?php } ?>
                    </div>
                </div>
                ...
                <div class="">
                    <div class="single-plan  mb-4 mb-sm-5 mb-lg-0" style="  background-image: linear-gradient(to right, #4e54c8, #8f94fb);">
                        ...
                        <h4 class="plan-price" style=" color: white;">kshs 450 <br> per week</h4>
                        <ul class="list-unstyled plan-list">
                        ...
                        <a class="btn single-plan-button" href="plazapayment.php?package=home&plan=3&freq=weekly" role="button">Order
                            Now</a>
                    <?php } ?>
                    </div>
                </div>
                ...
                <div class="">
                    <div class="single-plan mb-4 mb-sm-5 mb-lg-0 green" style="  background-image: linear-gradient(to right, #CAC531, #F3F9A7);">
                        ...
                        <h4 class="plan-price" style=" color: white;">kshs 550 <br> per week</h4>
                        ...
                        <a class="btn single-plan-button" href="plazapayment.php?package=home&plan=5&freq=weekly" role="button">Order
                            Now</a>
                    <?php } ?>
                    </div>
                </div>
            ...
            <div class="row d-row justify-content-center">
                ...
                <div class="">
                    <div class="single-plan mb-4 mb-sm-5 mb-lg-0 green" style="  background-image:linear-gradient(to right, #11998e, #38ef7d);">
                        <h3 class="plan-type" style=" color: white;"> 200GB</h3>
                        <h4 class="plan-price" style=" color: white;">kshs 850 <br> per month</h4>
                        ...
                        <a class="btn single-plan-button" href="plazapayment.php?package=home&plan=1&freq=monthly" role="button">Order
                            Now</a>
                    <?php } ?>
                    </div>
                </div>
                ...
                <div class="">
                    <div class="single-plan plan-popular mb-4 mb-sm-5 mb-lg-0" style="  background-image:linear-gradient(to right, #2193b0, #6dd5ed);">
                        ...
                        <h4 class="plan-price">kshs 1,200 <br> per month</h4>
                        <ul class="list-unstyled plan-list">
                            <li>2 mbps downloads</li>
                            <li>2 mbps uploads</li>
                            <li style=" color: white;">Unlimited Movies</li>
                        ...
                        <a class="btn plan-popular-button" href="plazapayment.php?package=home&plan=2&freq=monthly" role="button">Order
                            Now</a>
                    <?php } ?>
                    </div>
                </div>
                ...
                <div class="">
                    <div class="single-plan  mb-4 mb-sm-5 mb-lg-0" style="  background-image: linear-gradient(to right, #4e54c8, #8f94fb);">
                        ...
                        <h4 class="plan-price" style=" color: white;">kshs 1,600 <br> per month</h4>
                        <ul class="list-unstyled plan-list">
                            <li style=" color: white;">3 mbps downloads</li>
                            <li style=" color: white;">3 mbps uploads</li>
                            <li style=" color: white;">Unlimited Movies</li>
                        ...
                        <a class="btn single-plan-button" href="plazapayment.php?package=home&plan=3&freq=monthly" role="button">Order
                            Now</a>
                    <?php } ?>
                    </div>
                </div>
                ...
                <div class="">
                    <div class="single-plan mb-4 mb-sm-5 mb-lg-0 green" style="  background-image: linear-gradient(to right, #CAC531, #F3F9A7);">
                        ...
                        <a class="btn single-plan-button" href="plazapayment.php?package=home&plan=5&freq=monthly" role="button">Order
                            Now</a>
                    <?php } ?>
                    </div>
                </div>
    ...
    <?php } else {
    ?>
        <!-- </ul><a class="btn single-plan-button" href="plazaplazapayment.php?package=business&plan=2" role="button">Order Now</a> -->
    <?php } ?>
    <!-- </div>
                    </div> -->
    <!-- Single plan-->
    ...
    <!-- <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <?php } else {
                                ?>
                            </ul><a class="btn plan-popular-button" href="plazaplazapayment.php?package=business&plan=4" role="button">Order Now</a>
                        <?php } ?>
                        </div>
                    </div> -->
    <!-- Single plan-->
    ...
    <?php } else {
    ?>
        <!-- </ul><a class="btn single-plan-button" href="plazaplazapayment.php?package=business&plan=6" role="button">Order Now</a> -->
    <?php } ?>
    <!-- </div>
                    </div> -->
  ...
  <a href="lowbalance.html" rel="modal:open">
               ...
               <a href="lowbalance.html" rel="modal:open">
                                ...
                                <?php } else {
                                ?>
                            </ul><a class="btn plan-popular-button" href="plazaplazapayment.php?package=business&plan=10" role="button">Order Now</a>
                        <?php } ?>
                        </div>
                    </div>
                    ...
                    <div class="">
                        <div class="single-plan mt-4 mb-4 mb-sm-5 mb-lg-0">
                            ...
                            </ul><a class="btn single-plan-button" href="plazapayment.php?package=business&plan=15?" role="button">Order Now</a>
                        <?php } ?>
                        </div>
                    </div>
                </div>
