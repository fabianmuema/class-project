...
<head>
   ...
   ================================================== -->
    ...
    <meta name="keywords"
          content="juja internet, internet service provider in thika, wifi juja, fast internet nairobi, internet in nairobi ">
...
<header>
    ...
    <div class="topnav" id="myTopnav">
        <a href="#home" class="navbar-brand mr-auto"
           style="margin-left: -10px!important; margin-top: 1px!important; margin-right: 32%!important"></a>
        <?php if ($admin == false) { ?>
        ...
        <?php if ($admin == true) {
            ...
            <a class="nav-link py-0 text-light" href="dashboard/profiles.php"
               style="color: #f8f9fa!important;">Profiles</a>
            <a class="nav-link py-0 text-light" href="dashboard/payments.php"
               style="color: #f8f9fa!important;">Payments</a>
        ...
        <?php if ($admin == false) { ?>
            ...
            <a href="../dashboard/notifications.php" class="notifications">
                ...
                <span class="notification"
                      style="background: red; border-radius: 50%; padding: 5px;"><?php echo $count; ?></span>
            </a>
        <?php } ?>
    ...
    <div class="container">
        ...
        if ($new == 0) {
            ...
            <div class="row d-row d-flex justify-content-center" style="display: flex!important; flex-direction: row;">
                <!-- Single plan-->
                <div class="">
                    <div class="single-plan mb-4 mb-sm-5 mb-lg-0 green"
                        ...
                        <a class="btn single-plan-button" href="payment.php?package=home&plan=1&freq=daily"
                           role="button">Order
                            Now</a>
                        <?php } ?>
                    </div>
                ...
                <div class="">
                    <div class="single-plan plan-popular mb-4 mb-sm-5 mb-lg-0"
                        ...
                        <a class="btn plan-popular-button" href="payment.php?package=home&plan=2&freq=daily"
                           role="button">Order
                            Now</a>
                        <?php } ?>
                    </div>
                ...
                <div class="">
                    <div class="single-plan  mb-4 mb-sm-5 mb-lg-0"
                        ...
                        <a class="btn single-plan-button" href="payment.php?package=home&plan=3&freq=daily"
                           role="button">Order
                            Now</a>
                        <?php } ?>
                    </div>
                ...
                <!-- Single plan-->
                <div class="">
                    <div class="single-plan mb-4 mb-sm-5 mb-lg-0 gold"
                         style="  background-image: linear-gradient(to right, #CAC531, #F3F9A7);">
                        ...
                        <a class="btn single-plan-button" href="payment.php?package=home&plan=5&freq=daily"
                           role="button">Order
                            Now</a>
                        <?php } ?>
                    </div>
...
">
                    ...
                    <a class="btn plan-popular-button" href="payment.php?package=home&plan=2&freq=monthly"
                       role="button">Order
                        Now</a>
                    <?php } ?>
                </div>
...
<a id="scrolltop">
    <svg xmlns="http://www.w3.org/2000/svg" fill="white" width="44" height="44" viewBox="0 0 24 24">
