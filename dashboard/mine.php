    ...
    <header>
        ...
        <div class="topnav" id="myTopnav">
            <a class="navbar-brand mr-auto" href="#home"
               style="margin-left: -10px!important; margin-top: 1px!important; margin-right: 30%!important"></a>
            <?php if ($admin == false) { ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header" data-background-color="<?php echo $color; ?>">
                                <?php
                                $sql = "SELECT sum(mine) AS total FROM mine WHERE time >= '2020-03-01 00:00:00'";
                                $result = mysqli_query($conn, $sql);
                                $sum = mysqli_fetch_assoc($result);
                                ?>
                                <h4 style="color: white;">Fabian's total = kshs <?php echo $sum['total'];
                                    ?></h4>
                            </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <script>
                                            function clients() {
                                                ...
                                                xmlhttp.open("GET", "xialosi.php", true);
                                                xmlhttp.send();
