...
if (($admin != 1) and ($username != "fraizer")) {
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header" data-background-color="<?php echo $color; ?>">
                                <?php
                                $sql = "SELECT sum(fraizer) AS total FROM fraizer WHERE time > '2020-03-14 00:00:00'";
                                $result = mysqli_query($conn, $sql);
                                $sum = mysqli_fetch_assoc($result);
                                ?>
                                <h4 style="color: white;">Fraizer's total = kshs <?php echo $sum['total']; ?></h4>
                            </div>
                            <div class="card-content table-responsive">
                                <!--                                show fraizer's payments-->
                                <table class="table table-hover">
                                    ...
                                    <script>
                                            function clients() {
                                                ...
                                                xmlhttp.open("GET", "xialosi2.php", true);
                                                xmlhttp.send();
