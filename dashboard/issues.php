...
<body>
    ...
    ?>
        <div class="text-center">
            ...
            <H3>There are currently no issues.</H3>
        </div>
    <?php
    } else {
    ?>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><?php echo $issues['username']; ?></td>
                                                    <td><?php echo $issues['phone']; ?></td>
                                                    <td><?php echo $issues['mac']; ?></td>
                                                    <td><?php echo $issues['type']; ?></td>
                                                    <td><?php echo $issues['apartment']; ?></td>
                                                    <td><?php echo $issues['issue']; ?></td>
                                                    <td><a href="solved.php?id=<?php echo $issues['id']; ?>&username=<?php echo $issues['username']; ?>" class="btn btn-outline-secondary btn-sm">solved</a>
                                                <tr>
                                                <?php
                                                $i = $i + 1;
                                            } ?>
